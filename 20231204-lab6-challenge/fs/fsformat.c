...
void init_disk() {
    ...
    nbitblock = (NBLOCK + BIT2BLK - 1) / BIT2BLK; // BIT2BLK - 1 make sure if there is a block, there will be a bitmap
												  // and how many bitmap there are depends on NBLOCK / BIT2BLK
    nextbno = 2 + nbitblock;
